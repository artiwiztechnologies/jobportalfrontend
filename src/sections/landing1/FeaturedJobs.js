...
import imgF1 from "../../assets/feature-brand-1.png";
import imgF2 from "../../assets/feature-brand-2.png";
import imgF3 from "../../assets/feature-brand-3.png";
import imgF4 from "../../assets/feature-brand-4.png";
import imgF5 from "../../assets/feature-brand-5.png";
// import imgF6 from "../../assets/feature-brand-6.png";
          ...
          <div className="row justify-content-center">
            ...
            >
              ...
              <div className="bg-white px-8 pt-9 pb-7 rounded-4 mb-9 feature-cardOne-adjustments">
                ...
                <Link href="/#">
                  <a className="font-size-3 d-block mb-0 text-gray">Raymond</a>
                </Link>
                <h2 className="mt-n4">
                  <Link href="/#">
                    <a className="font-size-7 text-black-2 font-weight-bold mb-4">
            ...
            >
              ...
              <div className="bg-white px-8 pt-9 pb-7 rounded-4 mb-9 feature-cardOne-adjustments">
                ...
                <Link href="/#">
                  <a className="font-size-3 d-block mb-0 text-gray">Vardhman textiles</a>
                </Link>
                <h2 className="mt-n4">
                  <Link href="/#">
                    <a className="font-size-7 text-black-2 font-weight-bold mb-4">
            ...
            >
              ...
              <div className="bg-white px-8 pt-9 pb-7 rounded-4 mb-9 feature-cardOne-adjustments">
                ...
                <Link href="/#">
                  <a className="font-size-3 d-block mb-0 text-gray">Lakshmi mills</a>
                </Link>
                <h2 className="mt-n4">
                  <Link href="/#">
                    <a className="font-size-7 text-black-2 font-weight-bold mb-4">
            ...
            >
              ...
              <div className="bg-white px-8 pt-9 pb-7 rounded-4 mb-9 feature-cardOne-adjustments">
                ...
                <Link href="/#">
                  <a className="font-size-3 d-block mb-0 text-gray">Grasim Industries</a>
                </Link>
                <h2 className="mt-n4">
                  <Link href="/#">
                    <a className="font-size-7 text-black-2 font-weight-bold mb-4">
            ...
            >
              ...
              <div className="bg-white px-8 pt-9 pb-7 rounded-4 mb-9 feature-cardOne-adjustments">
                ...
                <Link href="/#">
                  <a className="font-size-3 d-block mb-0 text-gray">Welspun</a>
                </Link>
                <h2 className="mt-n4">
                  <Link href="/#">
                    <a className="font-size-7 text-black-2 font-weight-bold mb-4">
